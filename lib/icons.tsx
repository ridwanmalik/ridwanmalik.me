...
export const HackerRankIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg
    ...
    fill="none">
    <path
      d="M64.8625 40C65.2135 40 65.5 39.7255 65.5 39.3825V0.617499C65.5 0.274499 65.2135 0 64.8625 0H36.1375C35.7865 0 35.5 0.274499 35.5 0.617499V39.3825C35.5 39.7255 35.7865 40 36.1375 40H64.8625Z"
      fill="currentColor"
    />
    <path d="M30.5 0H20.284V14.9255H10.716V0H0.5V40H10.716V23.8315H20.284V40H30.5V0Z" fill="currentColor" />
  </svg>
)