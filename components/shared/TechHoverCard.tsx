import { TECHNOLOGIES, TECHNICAL_SKILLS } from "@/lib/constants"
...
export default function TechHoverCard({ techName, className = "", children }: TechHoverCardProps) {
  const tech = TECHNOLOGIES[techName as keyof typeof TECHNOLOGIES]
  const skill = TECHNICAL_SKILLS.find(s => s.name === techName)
